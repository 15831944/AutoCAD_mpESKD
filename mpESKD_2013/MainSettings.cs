namespace mpESKD
{
    ...
    public class MainSettings : INotifyPropertyChanged
    {
        ...
        {
            get => bool.TryParse(
                       UserConfigFile.GetValue("mpESKD", nameof(UseScaleFromStyle)),
                       out _useScaleFromStyle) && _useScaleFromStyle; // false
            set
            {
                _useScaleFromStyle = value;
                UserConfigFile.SetValue("mpESKD", nameof(UseScaleFromStyle), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => bool.TryParse(
                       UserConfigFile.GetValue("mpESKD", nameof(UseLayerFromStyle)),
                       out _useLayerFromStyle) && _useLayerFromStyle; // false
            set
            {
                _useLayerFromStyle = value;
                UserConfigFile.SetValue("mpESKD", nameof(UseLayerFromStyle), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => int.TryParse(
                UserConfigFile.GetValue("mpESKD", nameof(IfNoLayer)),
                out _ifNoLayer)
                ? _ifNoLayer
                : 0;
            set
            {
                _ifNoLayer = value;
                UserConfigFile.SetValue("mpESKD", nameof(IfNoLayer), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => bool.TryParse(
                       UserConfigFile.GetValue("mpESKD", nameof(UseTextStyleFromStyle)),
                       out _useTextStyleFromStyle) && _useTextStyleFromStyle; // false
            set
            {
                _useTextStyleFromStyle = value;
                UserConfigFile.SetValue("mpESKD", nameof(UseTextStyleFromStyle), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => int.TryParse(
                UserConfigFile.GetValue("mpESKD", nameof(IfNoTextStyle)),
                out _ifNoTextStyle)
                ? _ifNoTextStyle
                : 0;
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(IfNoTextStyle), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => int.TryParse(
                UserConfigFile.GetValue("mpESKD", nameof(MaxSelectedObjects)),
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(MaxSelectedObjects), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => Enum.TryParse(
                UserConfigFile.GetValue("mpESKD", nameof(LayerActionOnCreateAnalog)),
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(LayerActionOnCreateAnalog), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        {
            get => !bool.TryParse(
                       UserConfigFile.GetValue("mpESKD",
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(AxisLineTypeScaleProportionScale), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        public bool AxisSaveLastTextAndContinueNew
        {
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(AxisSaveLastTextAndContinueNew), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        public bool AxisUsePluginTextEditor
        {
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(AxisUsePluginTextEditor), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        #endregion
        ...
        public bool SectionSaveLastTextAndContinueNew
        {
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(SectionSaveLastTextAndContinueNew), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        public bool SectionShowHelpLineOnSelection
        {
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(SectionShowHelpLineOnSelection), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        public bool SectionUsePluginTextEditor
        {
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(SectionUsePluginTextEditor), value.ToString(), true);
                OnPropertyChanged();
            }
        }
        ...
        public bool SectionDependentTextMovement
        {
            ...
            set
            {
                ...
                UserConfigFile.SetValue("mpESKD", nameof(SectionDependentTextMovement), value.ToString(), true);
                OnPropertyChanged();
            }
        }
