...
namespace mpESKD.Functions.mpAxis
{
    public static class AxisDescriptor
    {
        ...
        public static string LName => Language.GetItem(MainFunction.LangItem, "h41"); // "Прямая ось";
        
        public static string Description => Language.GetItem(MainFunction.LangItem, "h65");// "Отрисовка прямой оси по ГОСТ 21.101-97";
        
        public static string FullDescription => Language.GetItem(MainFunction.LangItem, "h66");//"Создание интеллектуального объекта на основе анонимного блока, описывающего прямую ось по ГОСТ 21.101-97, путем указания двух точек";
